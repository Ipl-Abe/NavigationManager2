 ...
 */
NAVIGATION::MAP_RETURN_STATUS NAVIGATION_OccupancyGridMapServerSVC_impl::updateLocalMap(const NAVIGATION::OccupancyGridMap& map)
{
  // Please insert your code here and remove the following warning pragma
#ifndef WIN32
  #warning "Code missing in function <NAVIGATION::MAP_RETURN_STATUS NAVIGATION_OccupancyGridMapServerSVC_impl::updateLocalMap(const NAVIGATION::OccupancyGridMap& map)>"
#endif
  return 0;
}

NAVIGATION::MAP_RETURN_STATUS NAVIGATION_OccupancyGridMapServerSVC_impl::updateWholeMap(const NAVIGATION::OccupancyGridMap& map)
{
  // Please insert your code here and remove the following warning pragma
#ifndef WIN32
  #warning "Code missing in function <NAVIGATION::MAP_RETURN_STATUS NAVIGATION_OccupancyGridMapServerSVC_impl::updateWholeMap(const NAVIGATION::OccupancyGridMap& map)>"
#endif
  return 0;
}
