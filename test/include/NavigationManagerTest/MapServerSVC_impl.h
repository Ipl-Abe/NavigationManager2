   ...
   public virtual PortableServer::RefCountServantBase
{
 ...
 public:
   ...
   */
   ...
   NAVIGATION::MAP_RETURN_STATUS updateLocalMap(const NAVIGATION::OccupancyGridMap& map);
   NAVIGATION::MAP_RETURN_STATUS updateWholeMap(const NAVIGATION::OccupancyGridMap& map);
