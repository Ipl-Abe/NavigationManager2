...
#ifndef NAVIGATIONMANAGER_TEST__H
#define NAVIGATIONMANAGER_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  NavigationManagerTest(RTC::Manager* manager);
 ...
 protected:
  ...
  /*!
   */
  RTC::OutPort<RTC::TimedPose2D> m_currentRobotPoseOut;
...
extern "C"
{
  DLL_EXPORT void NavigationManagerTestInit(RTC::Manager* manager);
};

#endif // NAVIGATIONMANAGER_TEST_H
